...
exports.updateProductById = exports.getProducts = exports.getProductById = exports.getCountProducts = exports.deleteProductById = exports.createNewProduct = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            quantity = req.body.quantity; //Valida los datos
            ...
            return _context2.abrupt("return", res.status(400).json({
              msg: 'Bad requires, llene todos los campos'
            }));

          case 4:
            if (quantity == null) quantity = 0; //Realiza la consulta
...
var getCountProducts = /*#__PURE__*/function () {
  ...
  return function getCountProducts(_x5, _x6) {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            id = req.params.id; //Valida los datos
          ...
          case 6:
            pool = _context6.sent;
            _context6.next = 9;
            return pool.request().input('name', _database.sql.VarChar, name).input('description', _database.sql.Text, description).input('quantity', _database.sql.Int, quantity).input('id', _database.sql.Int, id).query(_database.queries.updateProductsById);
